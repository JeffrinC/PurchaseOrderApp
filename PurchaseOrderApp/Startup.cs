...
namespace PurchaseOrderApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<StockRuleSetConfiguration>(Configuration.GetSection(StockRuleSetConfiguration.StockRuleSet));
            services.AddSingleton<IInventoryStore>(new InventoryStore("inventory.json"));
